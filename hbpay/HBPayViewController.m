...
@interface HBPayViewController ()<UITextFieldDelegate>
{
...
- (void)viewDidLoad
{
    ...
    CGRect bound=CGRectMake(0, 0, 320, 134);
    ...
    NSArray *ImageArr=@[[UIImage imageNamed:@"Expression_1"],[UIImage imageNamed:@"Expression_2"],[UIImage imageNamed:@"Expression_3"] ];
    ...
    _scrollview.pagecontrol.currentcolor=[UIColor darkGrayColor];
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    /*CGPoint bottomOffset = CGPointMake(_scrollview.contentOffset.x, _scrollview.contentSize.height - _scrollview.bounds.size.height);
...
{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:nil message:@"点击了第一个页面" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles: nil];
    [alert show];
    NSLog(@"%@",sender.titleLabel.text);
}
#pragma mark ==========UIhbpayDelegate============
