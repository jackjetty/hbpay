...
//
// 默认是在navigationController环境下，如果不是在此环境下，请设置refreshHeader.isEffectedByNavigationController = NO;
...
- (void)layoutSubviews
{
   ...
   /* NSLog(@"%@",@"123");
    NSLog(@" %hhd",self.isManuallyRefreshing);
    NSLog(@" %d",!_hasLayoutedForManuallyRefreshing);
