...
- (void)setMessageModel:(MessageModel *)messageModel{
    ...
    if (_showTime){
        ...
        CGSize timeSize = [_messageModel.Time sizeWithFont:kTimeFont];
    ...
    CGSize contentSize = [_messageModel.Content sizeWithFont:kContentFont constrainedToSize:CGSizeMake(kContentW, CGFLOAT_MAX)];
