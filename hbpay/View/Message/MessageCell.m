...
- (void)setMessageFrame:(MessageFrame *)messageFrame{
    ...
    MessageModel *messageModel = _messageFrame.messageModel;
    
    // 1、设置时间
    [_timeBtn setTitle:messageModel.Time forState:UIControlStateNormal];
    ...
    [_contentBtn setTitle:messageModel.Content forState:UIControlStateNormal];
