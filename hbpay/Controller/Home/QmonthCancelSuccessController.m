...
@interface QmonthCancelSuccessController ()<UITableViewDataSource,UITableViewDelegate ,UITextFieldDelegate>
...
@end
@implementation QmonthCancelSuccessController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0){
        UILabel *label = [Utils labelWithFrame:CGRectMake(15.f, 10.f, screen_width-30, 50.f) withTitle:@"包月取消成功！" titleFontSize:[UIFont systemFontOfSize:18.f] textColor:RGB(73, 189, 36) backgroundColor:[UIColor clearColor] alignment:NSTextAlignmentCenter];
