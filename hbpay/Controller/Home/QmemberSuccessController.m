...
@interface QmemberSuccessController ()<UITableViewDataSource,UITableViewDelegate ,UITextFieldDelegate>
...
@end
@implementation QmemberSuccessController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0){
        UILabel *label = [Utils labelWithFrame:CGRectMake(15.f, 10.f, screen_width-30, 50.f) withTitle:@"恭喜您，包月信息提交成功！" titleFontSize:[UIFont systemFontOfSize:18.f] textColor:RGB(73, 189, 36) backgroundColor:[UIColor clearColor] alignment:NSTextAlignmentCenter];
    ...
    if (indexPath.section == 1){
        ...
        if (indexPath.row == 3){
            ...
            [cell addSubview:imageMiddle];
            UILabel *label = [Utils labelWithFrame:CGRectMake(30.f, 5.f, screen_width-60, 21.f) withTitle:@"" titleFontSize:[UIFont systemFontOfSize:13.f] textColor:[UIColor blackColor] backgroundColor:[UIColor clearColor] alignment:NSTextAlignmentLeft];
            NSString *labelText=[NSString stringWithFormat:@"会员类型：%@",  [Utils trim:self.appDelegate.qqMemberTypeName]];
            NSMutableAttributedString *AttributedStr = [[NSMutableAttributedString alloc]initWithString:labelText ];
        ...
        if (indexPath.row == 4){
            ...
            [cell addSubview:imageMiddle];
            UILabel *label = [Utils labelWithFrame:CGRectMake(30.f, 5.f, screen_width-60, 21.f) withTitle:@"" titleFontSize:[UIFont systemFontOfSize:13.f] textColor:[UIColor blackColor] backgroundColor:[UIColor clearColor] alignment:NSTextAlignmentLeft];
            NSString *labelText=[NSString stringWithFormat:@"业务类型：%@元", [Utils trim:self.appDelegate.qqMonth]];
            NSMutableAttributedString *AttributedStr = [[NSMutableAttributedString alloc]initWithString:labelText ];
